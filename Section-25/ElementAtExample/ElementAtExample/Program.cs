...
namespace LastExample
{
  ...
  internal class Program
  {
    static void Main(string[] args)
    {
      ...
      //ElementAt
      //Employee employee = employees.Where(e => e.Job == "Manager").ElementAt(1);
      //Console.WriteLine(employee.EmpID + "," + employee.EmpName + "," + employee.Job);

      //ElementAtOrDefault
      Employee employee = employees.Where(e => e.Job == "Manager").ElementAtOrDefault(21);
      if (employee != null)
